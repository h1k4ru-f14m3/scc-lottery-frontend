...
<template>
  <div v-if="!loading" class="flex flex-col justify-center items-center m-3" v-for="(item, index) in response.data">
    ...
    <p class="font-shan text-3xl p-1 md:text-5xl font-black md:p-3">{{ item[1] }}</p>
